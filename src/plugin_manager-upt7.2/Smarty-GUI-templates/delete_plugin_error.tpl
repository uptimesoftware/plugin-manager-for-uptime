...
<body>
<div class="TitleBar">Uninstall Plugin - {$plugin_info['name']}</div>
...
<i>WARNING: All monitors <u>must be deleted</u> in up.time for the uninstall to work!</i></p>
<input type='hidden' name='id' value="{$plugin_info['id']}">
<input type='hidden' id="retval" />
<input type='submit' name='yes' value='Yes' id="click_once" onclick="hide_submit_button();" />
